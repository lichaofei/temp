...
function openchurch_theme_preprocess_page(&$vars) {
  $vars['ie7_styles'] .= '<link type="text/css" rel="stylesheet" media="all" href="' . base_path() . path_to_theme().'/css/openchurch-ie7.css" />'."\n";
}

/**
 * Fixing empty breadcrumb issue
 */
function openchurch_theme_breadcrumb($breadcrumb) {
 ...
 * Block preprocessing
 */
function openchurch_theme_preprocess_block(&$vars) {
