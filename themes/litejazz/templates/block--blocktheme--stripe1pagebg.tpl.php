 ...
 */
?>
<div class="<?php print $attributes['class']; ?> customframeblock stripebox stripe1-box-page-bg" id="block-<?php print $block->module; ?>-<?php print $block->delta; ?>"<?php print $attributes; ?>>
    <div class="boxborder">
    <div class="bi">
