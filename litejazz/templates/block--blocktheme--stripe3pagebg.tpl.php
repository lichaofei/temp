 ...
 */
?>
<div class="<?php print $attributes['class']; ?> customframeblock stripebox stripe3-box-page-bg"<?php print $attributes; ?> id="block-<?php print $block->module; ?>-<?php print $block->delta; ?>">
    <div class="boxborder">
    <div class="bi">
